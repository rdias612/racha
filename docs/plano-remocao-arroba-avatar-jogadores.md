...
- [x] **Step 1: Checagem estática de tipos**
      Run: `npx tsc -p tsconfig.app.json`
      Expected: zero erros de compilação.

- [x] **Step 2: Formatação com Prettier**
      Run: `npm run format`
...
- [x] **Step 4: Inspeção manual dos fluxos da aplicação (`npm run dev`)**
