...
-- 6.5 Definir Confirmação de Presença Manualmente (Admin)
...
-- 6.6 Salvar Times de Linha e Goleiros Escalados (Admin)
...
BEGIN
  ...
  -- 1. Reverte estatísticas do evento antigo
...
-- 10.4 Obter Configurações de Notificação (Admin)
...
-- 10.5 Disparar Confirmação Manual (Admin)
...
-- 10.6 Disparar Push de Teste (Admin)
