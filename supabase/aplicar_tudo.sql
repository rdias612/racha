...
-- Ajusta a contagem de vagas para considerar exclusivamente atletas confirmados.
...
-- 087_rpc_salvar_caracteristicas_jogadores.sql
-- RPC transacional para salvar um LOTE de alterações de mensalista/admin
