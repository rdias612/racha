-- Migration 073: Atualiza resumo_ano(p_ano) para considerar somente jogadores
-- com pelo menos 33% das partidas jogadas no ano em todos os destaques do boletim.
