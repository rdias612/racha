      ...
      <form onSubmit={handleSubmit} className="p-4 space-y-3.5">
        ...
        <div className="pt-2 flex items-center justify-end gap-2 border-t border-borda">
          <button
            ...
            onClick={onClose}
            disabled={salvando}
            className="px-3.5 py-2.5 rounded-[4px] border border-borda text-xs font-display font-bold uppercase tracking-wider text-giz-fraco hover:text-giz hover:bg-superficie-2 transition min-h-[44px] focus-visible:outline-2 focus-visible:outline-destaque cursor-pointer"
          >
            Cancelar
          </button>
          <button
